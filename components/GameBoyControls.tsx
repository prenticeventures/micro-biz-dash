...
const GameBoyControls: React.FC<GameBoyControlsProps> = ({
  ...
  return (
    <div className="flex items-center justify-center gap-6 px-4">
      {/* D-Pad (Cross-shaped with left/right only) */}
      <div className="relative w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center flex-shrink-0 self-center">
        ...
        <button
          ...
          className={`absolute left-0 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-gray-700 rounded-l flex items-center justify-center transition-all touch-manipulation ${
            leftPressed 
        ...
        <button
          ...
          className={`absolute right-0 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-gray-700 rounded-r flex items-center justify-center transition-all touch-manipulation ${
            rightPressed 
              ? 'shadow-[inset_0_-2px_0_rgba(0,0,0,0.5),inset_0_2px_0_rgba(255,255,255,0.1)] translate-y-0.5' 
              : 'shadow-[inset_0_-4px_0_rgba(0,0,0,0.5),inset_0_2px_0_rgba(255,255,255,0.2)]'
          }`}
      ...
      {/* A Button (Red, to the right of D-pad) with Mute button underneath */}
      <div className="relative flex-shrink-0">
        <button
          ...
          className={`relative w-16 h-16 sm:w-20 sm:h-20 bg-red-600 rounded-full shadow-[inset_0_-6px_0_rgba(0,0,0,0.5),inset_0_3px_0_rgba(255,255,255,0.3),0_0_20px_rgba(220,38,38,0.4)] transition-all touch-manipulation ${
            aPressed 
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-white font-bold text-xl sm:text-2xl tracking-wider">A</span>
          </div>
        </button>
        ...
        {onMuteToggle && (
          <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 flex flex-col items-center gap-0.5">
            <button
              ...
              className="w-10 h-3 sm:w-12 sm:h-4 bg-black rounded shadow-[inset_0_-2px_0_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.2)] active:shadow-[inset_0_-1px_0_rgba(0,0,0,0.8)] active:translate-y-0.5 transition-all touch-manipulation"
